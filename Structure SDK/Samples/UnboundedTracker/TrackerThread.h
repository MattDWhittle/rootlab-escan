...
struct TrackerUpdate
{
    ...
    STTrackerHints trackerHints = { .trackerIsLost = YES, .sceneIsTooClose = NO, .modelOutOfView = NO };
    STTrackerPoseAccuracy poseAccuracy = STTrackerPoseAccuracyNotAvailable;
};
