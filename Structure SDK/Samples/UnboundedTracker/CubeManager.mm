...
-(SCNNode*) createFirstRoomCube
{
    ...
    cube.physicsBody.categoryBitMask = 2 ;
    ...
    [cube setPhysicsBodyAndContactTestBitMaskCollisionCategoryAll:[SCNPhysicsBody bodyWithType:SCNPhysicsBodyTypeDynamic shape:blockShape]];
