...
-(void) createDoorColliders;
{
    ...
    [self.door1Collider setPhysicsBodyAndContactTestBitMaskCollisionCategoryAll:blocker1Body];
    [self.door2Collider setPhysicsBodyAndContactTestBitMaskCollisionCategoryAll:blocker2Body];
    [self.door3Collider setPhysicsBodyAndContactTestBitMaskCollisionCategoryAll:blocker3Body];
...
-(void) physicsWorld:(SCNPhysicsWorld *)world didBeginContact:(SCNPhysicsContact *)contact
{
    ...
    if(nodeA == _gameData.player.playerNode && [nodeB.name containsString:@"firstTrigger"])
    {
