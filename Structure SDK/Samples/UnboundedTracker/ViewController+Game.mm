...
- (void) loadScene
{
    ...
    [floor setPhysicsBodyAndContactTestBitMaskCollisionCategoryAll:[SCNPhysicsBody staticBody]];
...
- (void) updateTutorialSceneKit
{
    ...
    switch (_tutorialStage)
    {
        ...
        case TutorialStage::NeedToTryWarp:
        {
            ...
            if (15.0f < [SCNTools vectorMagnitude:[SCNTools getWorldPos:_gameData.player.playerNode]])
