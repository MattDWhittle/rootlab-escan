...
static void preventApplicationFromStartingInTheBackgroundWhenTheStructureSensorIsPlugged ()
{
...
- (BOOL)application:(UIApplication *)application openURL:(NSURL*)url options:(NSDictionary<NSString *, id> *)options completionHandler:(void (^ __nullable)(BOOL success))completion sourceApplication:(NSString *)sourceApplication annotation:(id)annotation {
