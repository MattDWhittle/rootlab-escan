    ...
    if (self)
    {
        ...
        if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
        {
            ...
            _translationJoystick = [[Joystick alloc] initWithFrame:joystickFrame
                                                   backgroundImage:@"outer-circle.png"
                                                     joystickImage:@"inner-circle.png"];
        }
        else
        {
        ...
        _circle1 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"inner-circle.png"]];
        _circle2 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"inner-circle.png"]];
