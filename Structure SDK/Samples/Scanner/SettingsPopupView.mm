...
- (void) setupUIComponentsAndLayout
{
    ...
    // Streaming settings
    {
        ...
        streamPresetSegmentedControl = [[UISegmentedControl alloc] initWithItems:@[@"Default", @"Body", @"Outdoors"]];
    ...
    // Tracker Settings
    {
        ...
        improvedTrackerLabel.text = @"Improved Tracker (SDK 0.8+)";
...
- (void) setupComponentsWithDelegate:(id<SettingsPopupViewDelegate>)delegate
{
    ...
    heightConstraintWhenListModalIsShown = [NSLayoutConstraint constraintWithItem:self
                                                                        ...
                                                                        attribute:NSLayoutAttributeNotAnAttribute
                                                                       multiplier:1.0
                                                                         constant:screenBounds.size.height - 40];
