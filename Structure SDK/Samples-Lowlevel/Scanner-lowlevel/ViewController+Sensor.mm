...
{
    _appStatus.sensorStatus = AppStatus::SensorStatusIsWakingUp;
...
- (void)startStructureSensorStreaming
{
    ...
    if (_useColorCamera)
    {
        ...
        _structureStreamConfig = _options.useHardwareRegisteredDepth ?
            STStreamConfigRegisteredDepth320x240_Deprecated_OnlyForPre2017Devices : STStreamConfigDepth320x240;
